...
XSS は、2003 年から [OWASP Top 10][0] のセキュリティリスクとして取り上げられており、今でもよくある脆弱性の1つです。[2013年版][1]では、攻撃ベクトル、セキュリティの弱点、技術的な影響、ビジネスへの影響についていなどかなり詳しく書かれています。
...
このスニペットは、ポート `8080` で待ち受ける HTTP サーバを作成し、起動します

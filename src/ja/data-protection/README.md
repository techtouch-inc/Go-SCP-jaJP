...
たとえば、次のようなユーザー・ロールを持つ単純なオンラインストアを考えてみましょう。
...
1. HTTPS を使用していない場合、Man In The Middle (MITM) 攻撃によりデータを傍受される可能性があります。
...
ドキュメントによっては、Web アプリケーションを攻撃するために使われる可能性のあるバージョンや機能を明らかにしてしまうかもしれません。
